// Indian Cities with States data
class IndianCities {
  ...
  // Helper method to parse city and state from the format "City - State"
  static Map<String, String> parseCityState(String cityState) {
